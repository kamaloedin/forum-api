...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('THREAD_DETAILS.NOT_MEET_DATA_TYPE_SPECIFICATION'),
      ),
    ).toStrictEqual(
      new InvariantError(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('CREATE_REPLY.NOT_CONTAIN_NEEDED_PROPERTY'),
      ),
    ).toStrictEqual(
      new InvariantError(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('CREATE_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION'),
      ),
    ).toStrictEqual(
      new InvariantError(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('REPLY_DETAILS.NOT_CONTAIN_NEEDED_PROPERTY'),
      ),
    ).toStrictEqual(
      new InvariantError(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('REPLY_DETAILS.NOT_MEET_DATA_TYPE_SPECIFICATION'),
      ),
    ).toStrictEqual(
      new InvariantError(
